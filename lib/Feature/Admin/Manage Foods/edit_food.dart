...
class EditFood extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final nameController = TextEditingController(text: foodData['name']);
    final priceController = TextEditingController(
      text: foodData['price']?.toString(),
    );
    final descController = TextEditingController(text: foodData['description']);
    return SafeArea(
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: state.status == FoodStatus.loading
                        ? null
                        : () {
                            context.read<FoodCubit>().updateFood(
