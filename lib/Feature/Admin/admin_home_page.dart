...
class AdminHomePage extends StatelessWidget {
  ...
  const AdminHomePage({super.key, required this.onEdit,
        ...
        children: [
          Row(
            children: [
              ...
              SizedBox(width: 20,),
              Text("My Restaurants",style: TextStyle(color: AppColors.black,fontWeight: FontWeight.bold,fontSize: 20),),
              SizedBox(width: 40),
              Row(
                children: [
                  Stack(
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                SizedBox(width: 15),
                Text(
                  "Hi ${FirebaseAuth.instance.currentUser?.displayName ?? 'Admin'}",
                  style: TextStyle(
                    fontSize: 24,
          ...
          Padding(
              ...
              child: Text("My Restaurants",style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold),),
          ),

          Expanded(child: BlocBuilder<AddRestaurantCubit,AddRestaurantState>(
            ...
            if (state.restaurants.isNotEmpty) {
              return ListView.builder(
                ...
                itemBuilder: (context, index){
                  ...
                  return AdminRestaurantCard(context, restaurant, onEdit,onView);
                },
              );
            }
            ...
            return Center(child: Text(
              "No restaurants found", style: TextStyle(color: AppColors
                .primary, fontSize: 18, fontWeight: FontWeight
                .bold),),);
          },
          )
            )
